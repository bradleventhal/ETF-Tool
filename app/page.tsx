      ...
      <main className="flex min-h-screen flex-col items-center justify-center px-4" style={{ backgroundColor: "#f8fafc" }}>
        <div className="w-full max-w-sm">
          <div className="mb-8 flex flex-col items-center">
            <Image src="/images/logo.png" alt="Angel Oak Capital Advisors" width={200} height={60} className="mb-4" />
      ...
      <header style={{ backgroundColor: "#0f3d6b" }}>
        <div className="mx-auto flex max-w-6xl items-center justify-between px-6 py-3">
          <div className="flex items-center gap-4">
            <Image src="/images/logo.png" alt="Angel Oak Capital Advisors" width={160} height={44} style={{ filter: "brightness(0) invert(1)" }} />
        ...
        {result && mode === "advisor" && (
          <div className="py-8 space-y-8">
            ...
            <div className="pt-4 text-center" style={{ borderTop: "1px solid #e2e8f0" }}>
              <Image src="/images/logo.png" alt="Angel Oak Capital Advisors" width={120} height={36} className="mx-auto opacity-40" />
