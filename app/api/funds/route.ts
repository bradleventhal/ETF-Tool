...
const FALLBACK_FUNDS = [
  { ticker: "UYLD", name: "Angel Oak UltraShort Income ETF", duration: 0.8, ytwYtm: 4.6, distributionYield: 5.41, secYield: 4.7, expense: 0.34, sharpe: 2.44, ytd: 0.66, oneYear: 5.31, threeYear: 6.24, morningstarRating: 4, morningstarCategory: "Ultrashort Bond", correlation: 0.49, stdDev: 0.77, nonAgencyMbs: 14.3, agencyRmbs: 16.2, abs: 23.5, clo: 16.5, cmbs: 1.1, corporateCredit: 24.3 },
  ...
  { ticker: "VNLA", name: "Janus Henderson Short Duration Income ETF", duration: 0.92, ytwYtm: 4.29, distributionYield: 4.86, secYield: 4.2, expense: 0.23, sharpe: 1.9, ytd: 0.66, oneYear: 5.39, threeYear: 5.79, morningstarRating: 4, morningstarCategory: "Ultrashort Bond", correlation: 0.38, stdDev: 0.77, corporateCredit: 103.46 },
