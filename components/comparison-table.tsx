        ...
        <table className="w-full text-sm">
          ...
          <thead>
            <tr style={{ backgroundColor: "#f1f5f9", borderBottom: "1px solid #e2e8f0" }}>
              ...
              <th className="px-3 py-2.5 text-center font-mono text-[11px] font-bold uppercase tracking-wider sm:px-4" style={{ color: "#0f3d6b" }}>{tickerA}</th>
              <th className="px-3 py-2.5 text-center font-mono text-[11px] font-bold uppercase tracking-wider sm:px-4" style={{ color: "#64748b" }}>{tickerB}</th>
            </tr>
          </thead>
          <tbody>
            {rows.map((row, i) => (
              <tr key={row.label} style={{ backgroundColor: i % 2 === 0 ? "#fff" : "#f8fafc", borderBottom: i < rows.length - 1 ? "1px solid #f1f5f9" : undefined }}>
                ...
                <td className="whitespace-nowrap px-3 py-2 text-center font-mono text-[12px] sm:px-4 sm:text-[13px]">
